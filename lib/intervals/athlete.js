...
// PUT /athlete/{id}/sport-settings/{sportSettingsId}: merge parcial, solo
// cambia los campos enviados (mismo comportamiento que updateWellness).
// sportSettingsId es el id numérico del objeto sport-settings (no el nombre
// del deporte) — se resuelve primero con getAthleteSportSettings.
